...
-- function TLG.getDataFrom.User(data)

-- end

-- function TLG.getDataFrom.Chat(data)

-- end

-- function TLG.getDataFrom.Message(data)

-- end

-- function TLG.getDataFrom.PhotoSize(data)

-- end

-- function TLG.getDataFrom.Audio(data)

-- end

-- function TLG.getDataFrom.Document(data)

-- end

-- function TLG.getDataFrom.Sticker(data)

-- end

-- function TLG.getDataFrom.Video(data)

-- end

-- function TLG.getDataFrom.Voice(data)

-- end

-- function TLG.getDataFrom.Contact(data)

-- end

-- function TLG.getDataFrom.Location(data)

-- end

-- function TLG.getDataFrom.UserProfilePhotos(data)

-- end

-- function TLG.getDataFrom.File(data)

-- end

-- function TLG.getDataFrom.ReplyKeyboardMarkup(data)

-- end

-- function TLG.getDataFrom.ReplyKeyboardHide(data)

-- end

-- function TLG.getDataFrom.ForceReply(data)

-- end

-- function TLG.getDataFrom.InputFile(data)
